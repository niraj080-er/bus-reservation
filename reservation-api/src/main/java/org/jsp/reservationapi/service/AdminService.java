...
public class AdminService {
	...
	private Admin mapToAdmin(AdminRequest adminRequest) {
		return Admin.builder().email(adminRequest.getEmail()).phone(adminRequest.getPhone()).name(adminRequest.getName())
				.travels_name(adminRequest.getTravels_name()).password(adminRequest.getPassword()).gst_number(adminRequest.getGst_number()).build();
	}
}